...
#########################
BURIQ () {
    curl -sS https://wokszxd.xcodehoster.com/ipmini > /root/tmp
...
Name=$(curl -sS https://wokszxd.xcodehoster.com/ipmini | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://wokszxd.xcodehoster.com/ipmini | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
sleep 2
clear
wget https://wokszxd.xcodehoster.com/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
sleep 2
clear
wget https://wokszxd.xcodehoster.com/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://wokszxd.xcodehoster.com/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear

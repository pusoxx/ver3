...
echo -e "   ${BIGreen}[${BIWhite}03${BIGreen}]${BIBlue} •${NC} ${BIYellow}VLESS MENU      $NC  ${BIGreen}[${BIWhite}08${BIGreen}]${BIBlue} •$NC ${BIYellow}CHANGE DOMAIN      "
...
15) clear ; tcp ;;
16) clear ; addip-menu ;;
17) clear ; wget https://raw.githubusercontent.com/myridwan/src/main/xolpanel.sh && chmod +x xolpanel.sh && ./xolpanel.sh ;;

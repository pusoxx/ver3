...
echo -e "\e[1;97;101m    ∆ WOKSZXD PROJECT MANAGER COMMUNITY ∆   \033[0m"
echo -e "\033[1;36m──────────────────────────────────────────\033[0m"
echo -e "\033[1;36m┌──────────────────────────────────────────┐\033[0m"
echo -e "\033[1;36m│  ${PUTIH}01.${NC} ${BIRU}SSH OVPN MANAGER${NC} ${PUTIH}10.${NC} ${BIRU}RUNNING SERVICE${NC}"
echo -e "\033[1;36m│  ${PUTIH}02.${NC} ${BIRU}VMESS MANAGER${NC}    ${PUTIH}11.${NC} ${BIRU}SET REBOOT${NC}"
echo -e "\033[1;36m│  ${PUTIH}03.${NC} ${BIRU}VLESS MANAGER${NC}    ${PUTIH}12.${NC} ${BIRU}DOMAIN FREE${NC}"
echo -e "\033[1;36m│  ${PUTIH}04.${NC} ${BIRU}TROJAN MANAGER${NC}   ${PUTIH}13.${NC} ${BIRU}UPDATE SCRIPT${NC}"
echo -e "\033[1;36m│  ${PUTIH}05.${NC} ${BIRU}SHDWSK MANAGER${NC}   ${PUTIH}14.${NC} ${BIRU}INSTALL UDP${NC}"
echo -e "\033[1;36m│  ${PUTIH}06.${NC} ${BIRU}SETTINGS${NC}         ${PUTIH}15.${NC} ${BIRU}CHANGE NS SLOWDNS${NC}"
echo -e "\033[1;36m│  ${PUTIH}07.${NC} ${BIRU}TRIAL MANAGER${NC}    ${PUTIH}16.${NC} ${BIRU}INSTALL TCP${NC}"
echo -e "\033[1;36m│  ${PUTIH}08.${NC} ${BIRU}BACKUP RESTORE${NC}   ${PUTIH}17.${NC} ${BIRU}REG IP VPS${NC}"
echo -e "\033[1;36m│  ${PUTIH}09.${NC} ${BIRU}CHANGE DOMAIN${NC}    ${PUTIH}18.${NC} ${BIRU}WEBMIN MENU${NC}"
echo -e "\033[1;36m│  ${NC}"
echo -e "\033[1;36m│            ${PUTIH}19.${NC} ${BIRU}BOT MANAGER${NC}"     
echo -e "\033[1;36m│            ${PUTIH}99.${NC} ${BIRU}CLEAR CACHE${NC}"
echo -e "\033[1;36m└──────────────────────────────────────────┘\033[0m"
echo -e ""
echo -e "\033[1;36m┌──────────────────────────────────────────┐\033[0m"
echo -e " \e[1;97;101m    ∆ WOKSZXD PROJECT MANAGE AUTOSCRIPT ∆   \033[0m"
echo -e "\033[1;36m└──────────────────────────────────────────┘\033[0m"
echo ""

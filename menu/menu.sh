...
echo -e " ${BIRed}❐ RAM USAGE ${NC}           : ${green}$uram MB"
echo -e " ${BIRed}❐ SERVER UPTIME ${NC}       : ${green}$( uptime -p  | cut -d " " -f 2-10000 ) ${NC}"
echo -e " ${BIRed}❐ DATE & TIME ${NC}         : ${green}$( date -d "0 days" +"%d-%m-%Y | %X" )${NC}"
echo -e " ${BIRed}❐ CPU MODEL ${NC}           : ${green}$cname"
echo -e " ${BIRed}❐ CPU FREQUENCY ${NC}       : ${green}$freq MHz"
echo -e " ${BIRed}❐ NUMBER OF CORE ${NC}      : ${green}$cores"
